...
## Clock signal
set_property -dict { PACKAGE_PIN W5   IOSTANDARD LVCMOS33 } [get_ports iClk100m]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports iClk100m]
...
##Pmod Header JA
# Sensor pins aligned with standalone HCSR04 project
# HCSR04: Echo=JA7(H1), Trig=JA8(K2)
set_property -dict { PACKAGE_PIN K2   IOSTANDARD LVCMOS33 } [get_ports oHcsr04Trig]  ;# JA8
set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 } [get_ports iHcsr04Echo]  ;# JA7
# DHT11: Data=JA4(G2), single-wire line with pull-up
set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33 PULLUP true } [get_ports ioDht11Data]
